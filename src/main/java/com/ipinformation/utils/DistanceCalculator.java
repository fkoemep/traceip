package com.ipinformation.utils;

import org.springframework.beans.factory.annotation.Value;

public class DistanceCalculator {

    @Value("${ba.position.latitude}")
    private double baLatitude;

    @Value("${ba.position.longitude}")
    private double baLongitude;
    ...
    public double calculateDistanceFromBA(Integer lat, Integer lon) {
        return new DistanceCalculator().calculateDistance(baLatitude, baLongitude , lat, lon);
    }
